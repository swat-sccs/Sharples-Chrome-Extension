...
if (localStorage.getItem("tags") == "true"){  // if visibility is on, turn them on
...
$(document).ready(function(){
    ...
    function toggleTags() {
        ...
        if (typeof (Storage) !== "undefined") {
            ...
            document.getElementById("debug").textContent = "If you see this message, email ale3@swarthmore.edu. Error Code: 12b";
        }
    }
    ...
    // Only when the page is done loading, then may the page load user prefs
    // such as tag visibility and dark mode
    $.when(constructPage()).then(function () {
        setPrefs();
    })
